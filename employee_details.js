...
function displayEmployees() {
    ...
    //     return `<p>${employee.id}: Name: ${employee.name} - Department: ${employee.department} - Salary: $${employee.salary}</p>`;
    // }).join('');
...
// function calculateTotalSalaries() {
//     const totalSalaries = employees.reduce(function(acc, employee) {
